...
WebUI.setText(findTestObject('BRISURF UI/Custom/Login/username'), 'tulus')
...
WebUI.scrollToElement(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/ikonCeklis'), 0)

WebUI.click(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/ikonCeklis'))

//WebUI.click(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/dropdownPersetujuan'))
//
//WebUI.click(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/opsiPersetujuan'))

WebUI.delay(3)

WebUI.click(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/inputKeterangan'))

WebUI.setText(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/inputKeterangan'), 'testing')

WebUI.click(findTestObject('BRISURF UI/Custom/Menu Channel/Checker/btn Simpan'))
